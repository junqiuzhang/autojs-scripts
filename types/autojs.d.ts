...
declare module 'global' {
  ...
  type Gesture =
    | [number, number, GesturePoint, GesturePoint]
    | [number, GesturePoint, GesturePoint];
  /**
  ...
  namespace events {
    ...
    function on(
      event: 'key' | 'key_down' | 'key_up',
      listener: (keyCode: number, e: KeyEvent) => void
    ): void;
  ...
  namespace sensors {
    interface SensorEventEmitter {
      ...
      on(
        eventName: 'accuracy_change',
        callback: (accuracy: number) => void
      ): void;
    }
    function on(
      eventName: 'unsupported_sensor',
      callback: (sensorName: string) => void
    ): void;
  ...
  namespace http {
    ...
    function postMultipart(
      url: string,
      files: RequestMultipartBody,
      options?: HttpRequestOptions,
      callback?: (resp: Response) => void
    ): void;
    function postMultipart(
      url: string,
      files: { [key: string]: string } & RequestMultipartBody,
      options?: HttpRequestOptions,
      callback?: (resp: Response) => void
    ): void;
  ...
  namespace images {
    ...
    function findMultiColors(
      ...
      colors: [number, number, number | string][],
      options?: FindColorOptions
    ): Point;
  }
